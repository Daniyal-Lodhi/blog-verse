...
const Contact = () => {
  return (
    <>
       {/* Contact Start  */}
    <div class="container-xxl py-5" id="hello">
        <div class="container">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style= {{maxWidth: "500px"}}>
                <h1 class="display-5 mb-5 text-white pt-5">If You Have Any Query, Please Contact Us</h1>
            </div>
            <div class="row g-5">
                <div class="col-lg-6 " data-wow-delay="0.1s">
                    <h3 class="mb-4 text-white">Need a functional contact form?</h3>
                    ...
                    <form>
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <button class="btn btn-primary rounded-pill py-3 px-5" type="submit" id='submit' >Send Message</button>
                            </div>
                        </div>
                    </form>
                </div>
                <div class="col-lg-6 wow fadeInUp text-white" data-wow-delay="0.5s">
