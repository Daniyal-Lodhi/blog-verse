...
const Home = () => {
  ...
  return (
    <>
      ...
      <div className=' pt-5 pb-5' id='categories'>
      ...
      <div className='container'   >
        ...
        <div className="row justify-content-center mb-1 pb-5" >
          <div className="col-md-7 heading-section text-center ">
            <h2 className="mb-4 mt-4 text-white"  data-aos="fade-down" data-aos-delay="50" data-aos-duration="500" >Featured Blogs</h2>
            <p className='text-white'>One of the best blogs rated by our readers. Solely based on the current world topics.</p>
          </div>
        </div>
        <div className="row d-flex"  id='featBcont' >
          <div className="col-md-4 d-flex " >
          	<div className="blog-entry justify-content-end"  data-aos="fade-right" data-aos-delay="50" data-aos-duration="500" >
              ...
              <div className="text mt-3 float-right d-block">
              	<div className="d-flex align-items-center mb-3 meta">
	                <p className="mb-0">
	                	...
	                	<a href="#" className="mr-2"> by <i>Admin</i> </a>
          ...
          <div className="col-md-4 d-flex">
          	<div className="blog-entry justify-content-end"  data-aos="flip-right" data-aos-delay="50" data-aos-duration="500">
          ...
          <div className="col-md-4 d-flex ">
          	<div className="blog-entry rounded"  data-aos="fade-left" data-aos-delay="50" data-aos-duration="500" >
